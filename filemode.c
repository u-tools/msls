...
/* $Id: filemode.c,v 1.1 2004/02/02 07:16:24 alank Exp $ */
...
#pragma warning(disable: 4100) // ignore unused formal params
#pragma warning(disable: 4244) // ignore loss of precision
