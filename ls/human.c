...
#pragma warning(disable: 4244) // ignore conversion precision-loss errors
#pragma warning(disable: 4701) // ignore possible var use without set
#pragma warning(disable: 4706) // ok for assignment within conditional expr
