...
/* $Id: quotearg.c,v 1.1 2004/02/02 07:16:32 alank Exp $ */
...
//
// Added by AEK
#pragma warning(disable: 4244) // conv from int to char is ok
#pragma warning(disable: 4018) // == signed/unsigned mismatch is ok
